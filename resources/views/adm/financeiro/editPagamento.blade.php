...
<div class="row">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<form action="{{route('admin.financeiro.updatePagamento', $pagamento->id)}}" method="POST" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="text" name="linha_digitavel" value="{{$pagamento->linha_digitavel}}" class="form-control linha-digitavel"/>
				</div>
				<div class="row">
					<div class="col-md-8">
						<div class="form-group">
							<label>Valor</label>
							<input type="text" name="valor" value="{{$pagamento->valor}}" class="form-control moneySql" required/>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label>Vencimento</label>
							<input type="text" name="vencimento" value="{{$pagamento->vencimento}}" class="form-control datepicker dataCompleta" required/>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<input type="text" name="descricao" value="{{$pagamento->descricao}}" class="form-control"/>
				</div>

				<div class="form-group">
					<label>Observações</label>
					<textarea type="textarea" class="form-control" name="observacoes">{{$pagamento->observacoes}}</textarea>
				</div>

				<div class="form-group">
					<label>Arquivo pagamento</label>
					<input type="file" name="pagamento" value="{{$pagamento->pagamento}}" class="form-control"/>
				</div>
