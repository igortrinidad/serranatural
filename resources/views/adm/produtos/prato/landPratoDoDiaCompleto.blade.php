...
<p>
{!! isset($prato) ? nl2br($prato['acompanhamentos']) : 'acompanhamentos' !!}
</p>
<br>
...
<table width="100%">
    <thead>
        <tr>
            <th width="40%" align="center" >Ingredientes</th>
            <th width="30%" align="center">Quantidade</th>
            <th width="30%" align="center">Medida</th>
        </tr>
    </thead>
    <tbody>
    @foreach($prato['produtos'] as $ingredientes)
        <tr>
            <td width="40%" align="center">{{$ingredientes->nome_produto}}</td>
            <td width="30%" align="center">{{$ingredientes->pivot->quantidade}}</td>
            <td width="30%" align="center">{{$ingredientes->pivot->unidade}}</td>
        </tr>
    @endforeach
    </tbody>
</table>
