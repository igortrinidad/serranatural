		...
		<div class="panel-body">
			<form action="/admin/produtos/calcular/dateRange" method="post" class="form-inline" role="form">
				...
				<div class="form-group col-md-3">
					<input type="text" name="quantidade" placeholder="Número de pratos" v-model="numberOfPlates" value="" class="form-control"/>
				</div>
				
				
				<div class="form-group col-md-3">
					<button type="submit" class="btn btn-primary btn-block" :disabled="!numberOfPlates">Pesquisar</button>
				</div>
	  		...
	  		<table class="table table-hover">
		        ...
		        @foreach($agenda as $a)
		  			<tr>
		          		...
		          		<td>
		          			<a href="/admin/produtos/pratos/edita/{{$a->pratos->id}}"><i class="fa fa-pencil"></i></a>
		          		</td>
		          		<td>
		          			<a href="/admin/produtos/excluiPratoSemana/{{$a->id}}"><i class="fa fa-trash"></i></a>
		          		</td>
			          	<td>
			...
			'use strict';
				...
				$('input[name="dateRange"]').daterangepicker({
					    ...
					    "locale": {
					        "format": "MM/DD/YYYY",
					        "separator": " - ",
					        "applyLabel": "Aplicar data",
					        "cancelLabel": "Cancelar",
					        "fromLabel": "Inicio",
					        "toLabel": "Fim",
					        "customRangeLabel": "Alterar",
					        "weekLabel": "W",
					        "daysOfWeek": [
					            "Dom",
					            "Seg",
