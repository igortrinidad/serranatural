                        ...
                        @if($prato['foto'] != '')
                            <tr>
                                ...
                                <a href="https://admin.serranatural.com/arquivos/produtos/{{ $prato['foto'] }}" target="_blank">
                                    <img alt="Não abriu? Clique aqui para ver a foto." title="Não abriu? Clique aqui para ver a foto" src="https://admin.serranatural.com/arquivos/produtos/{{ $prato['foto'] }}" width="300px">
                                </a>
                                <br>
